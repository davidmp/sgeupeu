    ...
    function Paginate() {
        ...
        p.createNavigation = function (ft, tbody) {
            ...
            if (info.pages.length > 0) {
                ...
                $nav.append('<li class="footable-page-arrow"><a data-page="prev" href="#prev">Anterior</a></li>');
                $.each(info.pages, function (i, page) {
                    if (page.length > 0) {
                        $nav.append('<li class="footable-page"><a data-page="' + i + '" href="#">' + (i + 1) + '</a></li>');
                    }
                });
                $nav.append('<li class="footable-page-arrow"><a data-page="next" href="#next">próximo</a></li>');
            }
