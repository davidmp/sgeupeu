    ...
    <table data-filter="#filterestrategia" class="table table-bordered table-condensed footable table-hover" data-page-size="5" >
      ...
      <tbody>
                ...
                <tr>
                    ...
                    <a class="btn btn-small toltipx" href="<%=request.getContextPath()%>/GestionEstrategicoApoyo?opt=3&idpoliticasupeu=<%=pu.getIdpoliticasupeu()%>" title="Editar Datos"><div class="icon-edit"></div></a>
                    </td>
                </tr>
             <% }} %>
            </tbody>
