...
$(document).ready(function() {
    ...
    <body>
        <div class="row-fluid">
		<div class="span12">
	<form id="addPersona" name="addPersona" action="<%=request.getContextPath()%>/GestionEstrategicoApoyo" method="POST">     <fieldset>
	    <legend>Registro de Ejes y Objetivos Estrategicos</legend> 
            ...
            <div class="row-fluid">
				...
				<div class="span3">
                        ...
                        <a href="<%=request.getContextPath()%>/GestionEstrategicoApoyo?opt=35" class="btn">Cancelar</a>
                        </div>
            </fieldset>
        </form>
