...
<div   class="row-fluid">
                        ...
                        <div  class="span6" id="topmenu">
                            <a  href="<%=request.getContextPath()%>/GestionEstrategicoApoyo?opt=90" class="btn"><div class="icon-plus"></div>&nbsp;Registrar</a>
                            <a  href="<%=request.getContextPath()%>/GestionEstrategicoApoyo?opt=88" class="btn"><div class="icon-list"></div>&nbsp;Reportar</a>
                             <a  href="<%=request.getContextPath()%>/GestionEstrategicoApoyo?opt=87" class="btn"><div class="icon-remove"></div>&nbsp;Cerrar</a>
                        </div>
                       <div  class="span6">
      ...
      <tbody>
          <%
                 ...
                 <tr>
                    ...
                    <td>
                        <a class="btn btn-small toltipx" title="Eliminar Actividad" href="<%=request.getContextPath()%>/GestionEstrategicoApoyo?opt=91&idActividadIndicador=<%=a.getIdActividadIndicador()%>"><div class="icon-remove"></div></a>
                    </td>
