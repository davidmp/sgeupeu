    ...
    <body>
                    ...
                    <div   class="row-fluid">
                        <div  class="span3" id="topmenu" >
                            <a href="<%=request.getContextPath()%>/apps/app_gestion_estrategico_apoyo/add_post_estrategias.jsp" class="btn"><div class="icon-plus"></div>&nbsp;Registrar</a>
                            <a href="<%=request.getContextPath()%>/GestionEstrategicoApoyo?opt=57" class="btn"><div class="icon-remove"></div>&nbsp;Cerrar</a>
                        </div>
                        <div  class="span6"></div>
                        <div  class="span3">
      ...
      <tbody>
                ...
                <tr class="<% if(x%2==1){out.println("success");}%>">
                    ...
                    <td style="width: 10%;text-align: center;">
                        <a class="btn btn-small toltipx" title="Desea Editar" href="<%=request.getContextPath()%>/GestionEstrategicoApoyo?opt=59&idEstrategia=<%=es.getIdestrategia()%>"><div class="icon-edit"></div></a>
                        <a class="btn btn-small toltipx" title="Desea Eliminar" href="<%=request.getContextPath()%>/GestionEstrategicoApoyo?opt=61&idEstrategia=<%=es.getIdestrategia()%>"><div class="icon-remove"></div></a>
                    </td>
                </tr>
             <% }} %>
            </tbody>
