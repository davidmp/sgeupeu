...
p = (Usuario) request.getSession().getAttribute("listaPerfilUsuario");
	...
	<form id="addPersona" name="addPersona" action="<%=request.getContextPath()%>/Usuario" method="POST">
            <fieldset>
                <legend>Registro de Facultades con Responsables</legend>
	    <div class="row-fluid">
				<div class="span3">
                                    <label>Coordinador Facultad :</label>
				...
				<div class="span3">
                        ...
                        <a href="<%=request.getContextPath()%>/Usuario?opt=67" class="btn">Cancelar</a>
                        </div>
            </fieldset>
        </form>
