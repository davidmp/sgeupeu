 ...
 $('.toltipx').tooltip();
    ...
    <body>
		...
		<div class="span12">
            ...
            <a href="<%=request.getContextPath()%>/Usuario?opt=80" class="btn" ><div class="icon-plus"></div>&nbsp;Crear E.A.P</a>
      ...
      <tbody>
                ...
                <tr class="<% if(x%2==1){out.println("success");}%>">
                    ...
                    <td>
                        <a href="<%=request.getContextPath()%>/Usuario?opt=99&idEapFacultad=<%=us.getIdeapfacultad()%>" class="btn btn-small toltipx" title="Editar Este Campo"><div class="icon-edit"></div></a>
                        <a href="<%=request.getContextPath()%>/Usuario?opt=85&idEapFacultad=<%=us.getIdeapfacultad()%>" class="btn btn-small toltipx" title="Asignar Coordinador de Ejes Estrategicos"><div class="icon-user"></div></a>
                        <a href="<%=request.getContextPath()%>/Usuario?opt=82&idEapFacultad=<%=us.getIdeapfacultad() %>" class="btn btn-small toltipx" title="Desea Realmente Eliminar porque ya no es reversible"><div class="icon-remove"></div></a>
                   </td>
                </tr>
             <% }} %>
            </tbody>
