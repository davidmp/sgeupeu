...
<div class="row-fluid">
    ...
    <div class="span8">
        <form  id="form1" style="display: none" name="form1" action="../../InformesActividad" target="viewMain" >
        Periodo
    ...
    ejeEs=(List<Ejeestrategico>)request.getSession().getAttribute("listar_eje");              
        ...
        <form  id="form2" style="display: none" name="form2" action="../../InformesActividad" target="viewMain" >
        Periodo
