        ...
        <table style="width: 100%">
            ...
            <%
               ...
               <%  
                ...
                lista3=rs.objetivosEstrategicosPOA(Integer.parseInt(datos.get("ideapfacultad").toString()), Integer.parseInt(datos.get("ejeestrategicocodigo").toString()),periodo );
...
%>
<tr>
    <td style="width: 100%" colspan="2" align="center" style="background-color: #93a1a1">
        <table border="1" style="width: 100%;border-collapse:collapse">
            <tr>
                <td style="width: 90%; background-color: #93a1a1" align="right">
