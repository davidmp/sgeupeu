                ...
                <li class="dropdown">
                  ...
                  <ul  class="dropdown-menu">
                      ...
                      <li><a data-target=".marketing" data-toggle="tab" href="<%=request.getContextPath()%>/EvaluacionGeneral?opt=1&idfilial=<%if(fiU!=null){%><%=fiU.getIdfilial()%><%}else{%>0<%}%>&ideapfacultad=<%if(eU!=null){%><%=eU.getIdeapfacultad()%><%}else{%>0<%}%>&idfilialfacultad=<%if(faU!=null){%><%=faU.getIdfilialfacultad()%><%}else{%>0<%}%>"><div class="icon icon-minus"></div>&nbsp;Reporte de Evaluaci&oacute;n</a></li>
                        ...
                        <% // }%>
                        <li><a data-target=".marketing" data-toggle="tab" href="<%=request.getContextPath()%>/EvaluacionGeneral?opt=11&idfilial=<%if(fiU!=null){%><%=fiU.getIdfilial()%><%}else{%>0<%}%>&ideapfacultad=<%if(eU!=null){%><%=eU.getIdeapfacultad()%><%}else{%>0<%}%>&idfilialfacultad=<%if(faU!=null){%><%=faU.getIdfilialfacultad()%><%}else{%>0<%}%>"><div class="icon icon-minus"></div>&nbsp;Reporte de Evaluaci&oacute;n Todos</a></li>
                  </ul>
                </li>
                ...
                <li class="dropdown">
                 ...
                 <li class="dropdown">
                  ...
                  <ul  class="dropdown-menu">
                   ...
                   <li><a data-target=".marketing" data-toggle="tab" href="<%=request.getContextPath()%>/IndicadorTarea?opt=1&idfilial=<%if(fiU!=null){%><%=fiU.getIdfilial()%><%}else{%>0<%}%>&ideapfacultad=<%if(eU!=null){%><%=eU.getIdeapfacultad()%><%}else{%>0<%}%>&idfilialfacultad=<%if(faU!=null){%><%=faU.getIdfilialfacultad()%><%}else{%>0<%}%>"><div class="icon icon-minus"></div>&nbsp;Registrar Tarea</a></li>                    
<!--                   <li><a data-target=".marketing" data-toggle="tab" href="<%=request.getContextPath()%>/Indicador?opt=14&idfilial=<%if(fiU!=null){%><%=fiU.getIdfilial()%><%}else{%>0<%}%>&ideapfacultad=<%if(eU!=null){%><%=eU.getIdeapfacultad()%><%}else{%>0<%}%>&idfilialfacultad=<%if(faU!=null){%><%=faU.getIdfilialfacultad()%><%}else{%>0<%}%>"><div class="icon icon-minus"></div>&nbsp;Reportes Consolidados</a></li>-->
                ...
                %>
                  ...
                  <ul  class="dropdown-menu">
                    ...
                    <li><a data-target=".marketing" data-toggle="tab" href="<%=request.getContextPath()%>/IndicadorTareaEje?opt=1&idfilial=<%if(fiU!=null){%><%=fiU.getIdfilial()%><%}else{%>0<%}%>&ideapfacultad=<%if(eU!=null){%><%=eU.getIdeapfacultad()%><%}else{%>0<%}%>&idfilialfacultad=<%if(faU!=null){%><%=faU.getIdfilialfacultad()%><%}else{%>0<%}%>"><div class="icon icon-minus"></div>&nbsp;Registrar Tarea</a></li>                    
<!--                    <li><a data-target=".marketing" data-toggle="tab" href="<%=request.getContextPath()%>/IndicadoresEje?opt=14&idfilial=<%if(fiU!=null){%><%=fiU.getIdfilial()%><%}else{%>0<%}%>&ideapfacultad=<%if(eU!=null){%><%=eU.getIdeapfacultad()%><%}else{%>0<%}%>&idfilialfacultad=<%if(faU!=null){%><%=faU.getIdfilialfacultad()%><%}else{%>0<%}%>"><div class="icon icon-minus"></div>&nbsp;Reportes Consolidados</a></li>-->
                  ...
                  <%  } else if(opt==6){ %>
                        ...
                        <ul  class="dropdown-menu">
                         ...
                         <li><a data-target=".marketing" data-toggle="tab" href="<%=request.getContextPath()%>/EstadisticaGeneral?opt=1&idfilial=<%if(fiU!=null){%><%=fiU.getIdfilial()%><%}else{%>0<%}%>&ideapfacultad=<%if(eU!=null){%><%=eU.getIdeapfacultad()%><%}else{%>0<%}%>&idfilialfacultad=<%if(faU!=null){%><%=faU.getIdfilialfacultad()%><%}else{%>0<%}%>"><div class="icon icon-minus"></div>&nbsp;Reporte Estadistico</a></li>                                                  
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <% if(fiU.getIdfilial()==2){ %> <li><a data-target=".marketing" data-toggle="tab" href="<%=request.getContextPath()%>/EstadisticaGeneral?opt=11&idfilial=<%if(fiU!=null){%><%=fiU.getIdfilial()%><%}else{%>0<%}%>&ideapfacultad=<%if(eU!=null){%><%=eU.getIdeapfacultad()%><%}else{%>0<%}%>&idfilialfacultad=<%if(faU!=null){%><%=faU.getIdfilialfacultad()%><%}else{%>0<%}%>"><div class="icon icon-minus"></div>&nbsp;Reporte EstadisticoJ</a></li><li><a data-target=".marketing" data-toggle="tab" href="<%=request.getContextPath()%>/EvaluacionGeneral?opt=11&idfilial=<%if(fiU!=null){%><%=fiU.getIdfilial()%><%}else{%>0<%}%>&ideapfacultad=<%if(eU!=null){%><%=eU.getIdeapfacultad()%><%}else{%>0<%}%>&idfilialfacultad=<%if(faU!=null){%><%=faU.getIdfilialfacultad()%><%}else{%>0<%}%>"><div class="icon icon-minus"></div>&nbsp;Reporte de Evaluaci&oacute;nJ</a></li><% } %> 
