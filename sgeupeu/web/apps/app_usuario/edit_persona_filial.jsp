<%-- 
    Document   : edit_persona_filial
    Created on : 29/09/2013, 06:20:37 PM
    Author     : Edwin
--%>
	    ...
	    <legend>Editar Datos Personales</legend> 
            ...
            <div class="row-fluid">
				...
				<div class="span3">
                                    ...
                                    <label>Filial de Procedencia :</label><input type="text" name="" value="<%=per.getIdfilialname()%>" readonly="" />
                                    <input type="text" name="idfilial" value="<%=per.getIdfilial()%>" style="visibility: hidden;display: none;"/>
                               </div>
                        ...
                        <div id="topmenu">
                        <input type="hidden" name="opt" value="48"/>
                        <input type="submit" value="Actualizar" class="btn btn-success" />
                        <input type="reset" value="Limpiar" class="btn btn-warning"/>
                        <a href="<%=request.getContextPath()%>/Usuario?opt=41" class="btn">Cancelar</a>
                        </div>
            </fieldset>
        </form>
