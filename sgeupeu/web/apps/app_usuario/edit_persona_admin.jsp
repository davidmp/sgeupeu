<%-- 
    Document   : edit_persona_admin
    Created on : 29/09/2013, 10:05:34 AM
    Author     : Edwin
--%>
	    ...
	    <legend>Editar Datos Personales</legend> 
            ...
            <div class="row-fluid">
				...
				<div class="span3">
                                    ...
                                    <label>Fecha de Nac. :</label><input type="date" name="fechanacimiento" value="<%=per.getFechanacimiento()%>" placeholder="dd/mm/yyyy" required="required"/>
