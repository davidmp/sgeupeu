...
<%
 ...
 <div class="row-fluid">
		<div class="span6">
                    <form id="addActividadIndicadorAdmin" name="addActividadIndicadorAdmin" method="POST" action="<%=request.getContextPath()%>/GestionEstrategico">
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="form-actions" id="topmenu" style="text-align: right;">
                                    ...
                                    <a  href="<%=request.getContextPath()%>/GestionEstrategico?opt=88" class="btn"><div class="icon-remove"></div>&nbsp;Cerra </a>
