...
<div   class="row-fluid">
                        <div  class="span3" id="topmenu" >
                            <a href="<%=request.getContextPath()%>/GestionEstrategico?opt=62&idEjeX=<%=idEjeX%>" class="btn"><div class="icon-plus"></div>&nbsp;Registrar</a>
                            <a href="<%=request.getContextPath()%>/GestionEstrategico?opt=52&idEjeX=<%=idEjeX%>" class="btn"><div class="icon-remove"></div>&nbsp;Cerrar</a>
                        </div>
                        <div  class="span6"></div>
                        <div  class="span3">
      ...
      <tbody>
                ...
                <tr class="<% if(x%2==1){out.println("success");}%>">
                    ...
                    <td style="width: 10%;text-align: center;">
                        ...
                        <a class="btn btn-small toltipx" title="Desea Editar" href="<%=request.getContextPath()%>/GestionEstrategico?opt=4&idIndicador=<%=es.getIdindicador()%>"><div class="icon-edit"></div></a>
                         <a class="btn btn-small toltipx" title="Desea Eliminar" href="<%=request.getContextPath()%>/GestionEstrategico?opt=53&idIndicador=<%=es.getIdindicador()%>"><div class="icon-remove"></div></a>
