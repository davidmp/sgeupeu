...
return false;
    ...
    <body>
        ...
        %>
            ...
            <form method="POST" action="<%=request.getContextPath()%>/GestionEstrategico" name="addPersonaccc" id="addPersonaccc">
                 ...
                 <select name="idIndicador" class="toltipx" title="Selecciona Un Indicador para Asignar a la Estrategia" required="">
                    ...
                    <option value="<%=es.getIdindicador()%>"><%=es.getNombre()%></option>
                     ...
                     <div class="span3">
                        ...
                        <a href="<%=request.getContextPath()%>/GestionEstrategico?opt=15&idEjeX=<%=idEjeX%>" class="btn toltipx" title="Registrar Nuevo Indicador en la Base de Datos"><div class="icon icon-plus"></div>&nbsp;Configuracion</a>
      ...
      <tbody>
                ...
                <tr class="<% if(x%2==1){out.println("success");}%>">
                    ...
                    <td>
                        <a class="btn btn-small toltipx" title="Desea Eliminar" href="<%=request.getContextPath()%>/GestionEstrategico?opt=51&idestrategiaIndicador=<%=es.getIdestrategiaIndicador()%>"><div class="icon-remove"></div></a>&nbsp;
                        <a class="btn btn-small toltipx" title="Ingresar Actividades" href="<%=request.getContextPath()%>/GestionEstrategico?opt=86&idestrategiaIndicador=<%=es.getIdestrategiaIndicador()%>"><div class="icon-tasks"></div>&nbsp;Actividades</a>
