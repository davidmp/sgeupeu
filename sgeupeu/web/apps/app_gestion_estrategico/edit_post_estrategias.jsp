...
$(document).ready(function() {
    ...
    <body>
        ...
        <div class="row-fluid">
		<div class="span12">
	<form id="addEstrategias" name="addEstrategias" action="<%=request.getContextPath()%>/GestionEstrategico" method="POST">     <fieldset>
	    <legend>Actualizacion de Estrategias</legend> 
            ...
            <div class="row-fluid">
				...
				<div class="span3">
                        ...
                        <a href="<%=request.getContextPath()%>/GestionEstrategico?opt=56" class="btn">Cancelar</a>
                        </div>
            </fieldset>
        </form>
