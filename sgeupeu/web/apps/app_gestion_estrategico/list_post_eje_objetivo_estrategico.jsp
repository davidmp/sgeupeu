...
$(document).ready(function() {
 ...
 $('.toltipx').tooltip();
    ...
    <body>
       ...
       <div class="row-fluid">
       <div class="span12">
	<form id="addTemporadaEjeObjEst" name="addTemporadaEjeObjEst" action="<%=request.getContextPath()%>/GestionEstrategico" method="POST">
        ...
        List<Temporada> tem=(List<Temporada>) request.getSession().getAttribute("Listar_Rango_Temporada");
            ...
            <div class="row-fluid">
				...
				<div class="span3">
                        ...
                        <a href="<%=request.getContextPath()%>/GestionEstrategico?opt=35" class="btn toltipx" title="Registrar nuevo Eje Objetivo Estrategico en la Base de Datos"><div class="icon-wrench"></div>&nbsp;Configuracion</a>
                        </div>
                                </div>
                        <div class="span3"></div>
				<div class="span3">
	...
	<div class="row-fluid">
      ...
      <tbody>
                ...
                <tr class="<% if(x%2==1){out.println("success");}%>">
                    ...
                    <a class="btn btn-small toltipx" title="Desea Eliminar" href="<%=request.getContextPath()%>/GestionEstrategico?opt=39&IdTemporadaEjeEstrategico=<%=es.getIdTemporadaEjeEstrategico()%>"><div class="icon-remove"></div></a>
                    </td>
                </tr>
             <% }} %>
            </tbody>
      <tfoot class="footable-pagination pagination pagination-centered pagination-small">
		...
		<div class="span12">
                    ...
                    <form action="<%=request.getContextPath()%>/GestionEstrategico" method="post" name="addTemporadaEjeObjEst" id="addTemporadaEjeObjEst">
