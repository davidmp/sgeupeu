    ...
    <body>
        ...
        %>
         <div class="row-fluid">
             ...
             <div class="span4">
                 ...
                 <a href="<%=request.getContextPath()%>/GestionEstrategico?opt=56" class="btn toltipx" title="Registrar Nueva Estrategia"><div class="icon-wrench"></div>&nbsp;Configuracion</a>
      ...
      <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-small toltipx" title="Desea Eliminar<%=es.getIdEjeEstrategia()%>" href="<%=request.getContextPath()%>/GestionEstrategico?opt=45&idEjeEstrategia=<%=es.getIdEjeEstrategia()%>"><div class="icon-remove"></div></a>
                    </td>
                </tr>
             <% }} %>
            </tbody>
