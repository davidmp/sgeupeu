...
%>
        <div class="row-fluid">
		<div class="span12">
	<form id="addIndicador" name="addIndicador" action="<%=request.getContextPath()%>/GestionEstrategico" method="POST">     <fieldset>
            ...
            <div class="row-fluid">
				...
				<div class="span3">                                    
                    ...
                    <option value="<%=tm.getIdtipometa()%>"><%=tm.getTipo()%></option>
                        ...
                        <a href="<%=request.getContextPath()%>/GestionEstrategico?opt=15&idEjeX=<%=idEjeX%>" class="btn">Cancelar</a>
                        </div>
            </fieldset>
        </form>
