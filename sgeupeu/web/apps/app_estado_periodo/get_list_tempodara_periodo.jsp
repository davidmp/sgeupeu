   ...
   $(document).ready(function() {
    ...
    return false;
       ...
       <%
        ...
        <form name="addPeriodoMeta" id="addPeriodoMeta" method="POST" action="<%=request.getContextPath()%>/GestionEstrategico">
            <legend>Registro de Periodos Segun la Temporada Seleccionada</legend>
        <div class="row-fluid">
            <div class="span3">
                
                
                <select name="" class="span4" onchange="valorperiodo(this.value);sumar();" required="required">
                    <option></option>
                    <%
                int a=0;
                ...
                F. Inicio:
                <input type="text" name="fechaini" value="" class=" span5 " id="fechaini" />                
            </div>
            <div class="span3">                
                F. Fin:
                <input type="text" name="fechafin" value="" class=" span5 " id="fechafin" />                
            </div>                
            <div class="span3">
                <div id="topmenu">
