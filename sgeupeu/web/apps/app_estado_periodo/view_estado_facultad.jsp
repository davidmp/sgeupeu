...
$('.toltipx').tooltip();
        ...
        function getEstadoPeriodoFacultad(id){
        $("#ListaEstadoPeriodoFacultad").html("<div><center><img src='<%=request.getContextPath()%>/resources/img/loading.gif' width='16' height='11' alt='loading'/></center></div>");    
        $.ajax({
            url: '<%=request.getContextPath()%>/GestionEstrategico?opt=78',
            type: 'POST',
            async: true,
            data: 'getIDFilialFacultad='+id, 
            success: function(data) {
            $('#ListaEstadoPeriodoFacultad').fadeIn(1000).html(data);
        ...
        <div class="row-fluid">
		 ...
		 <div class="span3">
                     ...
                     <select id="comboFacultades" onchange="getEstadoPeriodoFacultad(this.value);">
       ...
       <div class="row-fluid">
		 <div class="span12" id="ListaEstadoPeriodoFacultad">
		</div>
	</div>
