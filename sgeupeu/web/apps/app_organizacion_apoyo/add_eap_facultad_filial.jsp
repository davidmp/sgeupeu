...
$(document).ready(function() {
	...
	<form id="addPersona" name="addPersona" action="<%=request.getContextPath()%>/UsuarioApoyo" method="POST">
            <fieldset>
            <legend>Registro de Oficinas de Direcciones de Apoyo</legend> 
	    <div class="row-fluid">
				<div class="span3">
				...
				<div class="span3">
                                    <label>Direcci&oacute;n de Apoyo :</label>
				...
				<div class="span3">
                    ...
                    <option value="<%=ce.getIdCoordinadorEap()%>"><%=ce.getIdperiodo_name()%>&nbsp;<%=ce.getIdpersona_nombre()%>&nbsp;<%=ce.getIdpersona_apellpaterno()%>&nbsp;<%=ce.getIdpersona_apellmaterno()%></option>
                        ...
                        <a href="<%=request.getContextPath()%>/UsuarioApoyo?opt=79" class="btn">Cancelar</a>
                        </div>
            </fieldset>
        </form>
