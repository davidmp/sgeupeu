 ...
 $('.toltipx').tooltip();
    ...
    <body>
		...
		<div class="span12">
            ...
            <a href="<%=request.getContextPath()%>/UsuarioApoyo?opt=76" class="btn" ><div class="icon-plus"></div>&nbsp;Crear Unidad de Apoyo</a>
      ...
      <thead>
        ...
        <tr>
           ...
           <th>
               Nombre de Direcci&oacute;n de Apoyo
          </th>
          <th data-hide="phone">
      ...
      <tbody>
                ...
                <tr class="<% if(x%2==1){out.println("success");}%>">
                    ...
                    <td>
                        <a href="<%=request.getContextPath()%>/UsuarioApoyo?opt=99&idFilialfacultad=<%=us.getIdfilialfacultad()%>" class="btn btn-small toltipx" title="Editar Este Campo"><div class="icon-edit"></div></a>
                        <a href="<%=request.getContextPath()%>/UsuarioApoyo?opt=78&idFilialfacultad=<%=us.getIdfilialfacultad()%>" class="btn btn-small toltipx" title="Desea Realmente Eliminar porque ya no es reversible ; Para eliminar este campo deber de eliminar como reponsable de EAP"><div class="icon-remove"></div></a>
                   </td>
                </tr>
             <% }} %>
            </tbody>
