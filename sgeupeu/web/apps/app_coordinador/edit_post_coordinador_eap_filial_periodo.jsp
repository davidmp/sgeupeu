<%-- 
    Document   : edit_post_coordinador_eap_filial_periodo
    Created on : 01/10/2013, 01:28:45 AM
    Author     : Edwin
--%>
...
$(document).ready(function() {
    ...
    <body>
        ...
        Coordinadoreap to = null;
        to = (Coordinadoreap) request.getSession().getAttribute("listaCoordinadorEAPById");
	...
	<form id="addPersona" name="addPersona" action="<%=request.getContextPath()%>/Usuario" method="POST">
            <fieldset>
	    <legend>Actualizacion de Coordinador EAP Filial</legend> 
            ...
            <%}}%>
				...
				<div class="span3">
                        ...
                        <hr>
                        <div id="topmenu">
                            <input type="hidden" name="idCoordinadorEap" value="<%=to.getIdCoordinadorEap()%>"/>      
                        <input type="hidden" name="opt" value="65"/>  
                        <input type="submit" value="Actualizar" class="btn btn-success" />
                        <input type="reset" value="Limpiar" class="btn btn-warning"/>
                        <a href="<%=request.getContextPath()%>/Usuario?opt=64" class="btn">Cancelar</a>
                        </div>
            </fieldset>
        </form>
