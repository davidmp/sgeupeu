<%-- 
    Document   : list_pre_coordinador_filial_periodo
    Created on : 30/09/2013, 03:22:57 AM
    Author     : Edwin
--%>
...
$(document).ready(function() {
    ...
    return false;
        ...
        $.ajax({
            url: '<%=request.getContextPath()%>/Usuario?opt=52',
            type: 'POST',
            async: true,
            data: 'idperi='+id, 
    ...
    <body>
        ...
        <div class="row-fluid">
            <div class="span12">
                <select name="" onchange="showedwinajax(this.value);" class="pull-left toltipx" title="Selecciona un Periodo para Listar y Registrar los Coordinadores de Facultad" style="width: 10%;">
                    <option value=""></option>
