<%-- 
    Document   : list_post_coordinador_filial_periodo
    Created on : 30/09/2013, 03:23:12 AM
    Author     : Edwin
--%>
    ...
    <body>
        ...
        <div class="row-fluid">
         ...
         <form id="addPersona" name="addPersona" action="<%=request.getContextPath()%>/Usuario" method="POST">
                  ...
                  <%
                   ...
                   <input type="hidden" name="opt" value="54" />
      ...
      <thead>
        ...
        <tr>
          ...
          <th>
              Coordinadores de Facultad/UPG/&Aacute;reas
          </th>
          <th data-hide="phone">
            DNI Persona
          </th>
      ...
      <tbody>
                <%
                        int x=0;     
                        List<Coordinadorfacultad> lista=(List<Coordinadorfacultad>) request.getSession().getAttribute("listar_Coordinador_facultad");
                        if (lista != null) {
                            for (Coordinadorfacultad us : lista) {
                ...
                <tr class="<% if(x%2==1){out.println("success");}%>">
                    ...
                    <td>
                        <a href="<%=request.getContextPath()%>/Usuario?opt=56&idCoordinadorFacultad=<%=us.getIdcoordinadorfacultad()%>" class="btn btn-small"><div class="icon-edit"></div></a>
                        <a href="<%=request.getContextPath()%>/Usuario?opt=55&idCoordinadorFacultad=<%=us.getIdcoordinadorfacultad()%>" class="btn btn-small toltipx" title="Desea Realmente Eliminar porque ya no es reversible"><div class="icon-remove"></div></a>
                    </td>
                </tr>
             <% }} %>
            </tbody>
