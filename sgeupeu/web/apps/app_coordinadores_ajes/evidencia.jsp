...
function formindicador(numero) 
{
	...
	<div class="row-fluid">
        ...
        <div class="uneditable-input span3"><i class="icon-file fileupload-exists"></i> 
         ...
         <span class="btn btn-file"><span class="fileupload-new">Buscar</span>
             <span class="fileupload-exists">Cambiar</span><input type="file" name="fichero"/></span>
 ...
 <table class="table table-bordered table-hover"    >
   ...
   <form class="eliminar_1" name="eliminar_1" action="<%=request.getContextPath()%>/IndicadoresEje" method="POST">  
   ...
   <form id="atras_1" name="atras_1" action="<%=request.getContextPath()%>/IndicadoresEje" method="POST"> 
