...
<script type="text/javascript">
 ...
 <div class="row-fluid">
     ...
     <form id="eje" name="eje"  action="<%=request.getContextPath()%>/IndicadoresEje?opt=24&idfilial=<%if(fiU!=null){%><%=fiU.getIdfilial()%><%}else{%>0<%}%>&ideapfacultad=<%if(eU!=null){%><%=eU.getIdeapfacultad()%><%}else{%>0<%}%>&idfilialfacultad=<%if(faU!=null){%><%=faU.getIdfilialfacultad()%><%}else{%>0<%}%>&idperiodometa=<%=idperidoM.getIdperiodometa()%>" >
     ...
     <div class="span4" style="<%if(eje!=null){ out.print("display: normal"); }else{ out.print("display: none");}%> ">
        ...
        <form id="buscar" name="buscar"  action="<%=request.getContextPath()%>/IndicadoresEje" >
...
<tbody>
                ...
                <%-- META inicio--%> 
                    ...
                    int idEjeEstrategicoX=wr.getIdejeestrategico();
                       ...
                       %>                       
                            <%{   %>  
                   <form  class="claseform" name="claseform" id="claseform" onsubmit="return validarNumeroMeta(<%=in.getNro()%>)" action="<%=request.getContextPath()%>/IndicadoresEje" method="POST">
                        <center>
                            <p></p>
                            <p></p>
...
<%}
         ...
         <%-- META FIN--%>  
            ...
            <%-- INICIO avance--%>
                    ...
                    <td>
                        ...
                        %>                        
                      <form class="claseform1" name="claseform1" action="<%=request.getContextPath()%>/IndicadoresEje" method="POST">    
                        <center>         
                    ...
                    <td >
                     <form class="claseform2" name="claseform2" id="claseform2<%=in.getNro()%>" action="<%=request.getContextPath()%>/IndicadoresEje" method="POST">    
                        <center>
            ...
            <input type="hidden"  name="valor" value="<%if(name!=null){%><%=name.getNombre()%><%}%>" >
                      <input type="hidden"  name="nro_avance<%=in.getNro()%>" value="<%if(nrometa!=null){%><%=nrometa.getId_ciclo() %><%}else{%>0<%}%>" >
                        ...
                        <input type="hidden"  name="idavance<%=in.getNro()%>" value="<%if(av!=null){%><%=av.getIdavance()%><%}else{%>0<%}%>" > 
                          <%if(in.getMeta()!=0){%>
                         <%if(in.getEstadoavance()!=0){%>
                        <input type="button" onclick="validarNumeroAvance(<%=in.getNro()%>)" onmouseover="formindicador_2(<%=in.getNro()%>)" value="Aceptar" <%if(nrometa!=null){if(in.getNro()==nrometa.getIdmeta()){ }else{out.print("disabled");}}else{out.print("disabled");}%> class="btn btn-mini btn-success"/>
                        <%}%>
                        <%}%>
 ...
 %>
                ...
                <p></p>
                 <br>
                    ...
                    <%if(in.getTotalavance()!=0){%>  
                         ...
                         <form class="claseform4" name="claseform4" action="<%=request.getContextPath()%>/IndicadoresEje?opt=21&idfilial=<%if(fiU!=null){%><%=fiU.getIdfilial()%><%}else{%>0<%}%>&ideapfacultad=<%if(eU!=null){%><%=eU.getIdeapfacultad()%><%}else{%>0<%}%>&idfilialfacultad=<%if(faU!=null){%><%=faU.getIdfilialfacultad()%><%}else{%>0<%}%>&idperiodometa=<%if(idperidoM!=null){%><%=idperidoM.getIdperiodometa()%><%}else{%>0<%}%>" method="POST">    
     ...
     <% }
        ...
        <tr>
            <td colspan="12" style="text-align: center;"><ul id="pagination" class="footable-nav" /></td>
        </tr>
      </tfoot>  
    </table>      
