...
function validarNumeroDecimales(){
	...
	<div class="span12">
         ...
         <form id="addactividad" name="addactividad" action="<%=request.getContextPath()%>/Indicador"  method="POST">     
    ...
    <form id="editar" class="editar" name="editar" action="<%=request.getContextPath()%>/Indicador" method="POST">
...
,'<%=me.getIdactividad()%>'
   ...
   <form id="atras" name="atras" action="<%=request.getContextPath()%>/Indicador" method="POST"> 
