 ...
 * @author Intel
 */
@WebServlet(name = "IndicadoresEje", urlPatterns = {"/IndicadoresEje"})
public class IndicadoresEje extends HttpServlet {
     private static String INDEXCOORDINADOREAP= "apps/app_coordinadores_ajes/index.jsp";     
     private static String LIST_INDICADOR= "apps/app_coordinadores_ajes/list_indicador.jsp";
     private static String POA= "apps/app_coordinadores_ajes/poa.jsp";
     private static String EVIDENCIA= "apps/app_coordinadores_ajes/evidencia.jsp";
