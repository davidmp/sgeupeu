 ...
 * @author Intel
 */
@WebServlet(name = "GestionEstrategicoApoyo", urlPatterns = {"/GestionEstrategicoApoyo"})
public class GestionEstrategicoApoyo extends HttpServlet {
 ...
 String alert_true="<div class='alert alert-success'><script>window.setTimeout(function() { $('.alert').alert('close'); }, 3000);</script><h4>Alert!</h4>Se Registro Correctamente !!</div>";
    ...
    private static String LISTAPOLITICAUPEU= "apps/app_gestion_estrategico_apoyo/list_politica_upeu.jsp";
    private static String DATOSPOLITICAUPEU= "apps/app_gestion_estrategico_apoyo/datos_politica_upeu.jsp";
    
    // LISTA DE EJES Y OBJETIVOS ESTRATEGICOS
    
    private static String LISTAEJESESTRATEGICOS= "apps/app_gestion_estrategico_apoyo/list_pre_eje_objetivo_estrategico.jsp";
    private static String LISTAEJESOBJESTRATEGICOS= "apps/app_gestion_estrategico_apoyo/list_post_eje_objetivo_estrategico.jsp";
    private static String DATOSEJESESTRATEGICOS= "apps/app_gestion_estrategico_apoyo/datos.jsp";
    
    private static String ADDEJESOBJESTRATEGICOS= "apps/app_gestion_estrategico_apoyo/add_eje_objetivo.jsp";
    private static String EDITEJESOBJESTRATEGICOS= "apps/app_gestion_estrategico_apoyo/edit_eje_estrategico.jsp";
    
    private static String ADDEJESOBJESTRATEGICOSTEMPORADA= "apps/app_gestion_estrategico_apoyo/add_eje_objetivo_temporada.jsp";
    
    
    
    // LISTA DE ESTRATEGIA
    
    private static String LISTPREESTRATEGIAS= "apps/app_gestion_estrategico_apoyo/list_pre_estrategias.jsp";
    private static String LISTCOMBOEJESOBJ= "apps/app_gestion_estrategico_apoyo/get_list_combo_ejes_objetivos.jsp";
    private static String LISTPOSTESTRATEGIAS= "apps/app_gestion_estrategico_apoyo/list_post_estrategias.jsp";
    private static String LISTAESTRATEGIA= "apps/app_gestion_estrategico_apoyo/config_list_estrategia.jsp";
    private static String EDITESTRATEGIA= "apps/app_gestion_estrategico_apoyo/edit_post_estrategias.jsp";
    ...
    private static String LISTAINDICADOR= "apps/app_gestion_estrategico_apoyo/list_indicador.jsp";
    private static String ADDINDICADOR= "apps/app_gestion_estrategico_apoyo/add_indicador.jsp";
    private static String ADDPOSTINDICADOR= "apps/app_gestion_estrategico_apoyo/add_post_indicador.jsp";
    private static String EDITPOSTINDICADOR= "apps/app_gestion_estrategico_apoyo/edit_post_indicador.jsp";
    
    private static String LISTPREINDICADOR= "apps/app_gestion_estrategico_apoyo/list_pre_indicador.jsp";
    private static String LISTCOMBOEJESOBJINDICADOR= "apps/app_gestion_estrategico_apoyo/get_list_combo_objetivos.jsp";
    private static String LISTCOMBOESTRATEGIASINDICADOR= "apps/app_gestion_estrategico_apoyo/get_list_combo_estrategias.jsp";
    private static String LISTPOSTESTRATEGIASINDICADOR= "apps/app_gestion_estrategico_apoyo/list_post_indicador.jsp";
    ...
    private static String INDEXGESTIONESTRATEGICO= "apps/app_gestion_estrategico_apoyo/index.jsp";
    ...
    private static String LISTACTIVIDADES= "apps/app_gestion_estrategico_apoyo/list_actividades_indicador.jsp";
    private static String ADDACTIVIDADES= "apps/app_gestion_estrategico_apoyo/add_actividad_indicador.jsp";
    
    public int idTipoAreaPri=0;
    public int idTipoAreaApoPri=3;
        ...
        try {
            ...
            switch (opt) {
               ...
               case 5: {
                   ...
                   request.getSession().setAttribute("listar_tipo_meta", listarTipoMeta);
                   ges=new GestionEstrategicoService();
                   List listar_indicador = ges.Listar_Indicador(idTipoAreaApoPri, Integer.parseInt(idFilialPri), idEjeEstrategicoPri);
                ...
                case 6: {
                   ...
                   ges=new GestionEstrategicoService();
                   List listarEjesEstrategicos = ges.Listar_Ejes_Estrategicos(idTipoAreaApoPri);
               ...
               case 8: {
                   ...
                   //Fin de la funcion                     
                   ges=new GestionEstrategicoService();
                   List listarEstrategia = ges.Listar_Estrategia(idTipoAreaApoPri, Integer.parseInt(idFilialPri));
               ...
               case 10: {
                   ...
                   //Fin de la funcion                    
                   ges=new GestionEstrategicoService();
                   List listarIndicador = ges.Listar_Indicador(idTipoAreaApoPri, Integer.parseInt(idFilialPri), idEjeEstrategicoPri);
               ...
               case 15: {
                   ...
                   ges=new GestionEstrategicoService();
                   List listarEjeEstrategico = ges.Listar_Ejes_Estrategicos(idTipoAreaApoPri);
                   ...
                   request.getSession().setAttribute("listar_tipo_meta", listarTipoMeta);
                   ges=new GestionEstrategicoService();
                   List listar_indicador = ges.Listar_Indicador(idTipoAreaApoPri, Integer.parseInt(idFilialPri),idEjeX);
                   request.getSession().setAttribute("listar_indicador", listar_indicador);
               ...
               case 16: {
                   ...
                   ges=new GestionEstrategicoService();
                    ...
                    request.getSession().setAttribute("Listar_Estrategias_Indicador",ges.Listar_Estrategia_Indicador(id, idTipoAreaApoPri, Integer.parseInt(idFilialPri)));
                    ges=new GestionEstrategicoService();
                    List listarIndicadores = ges.Listar_Indicador(idTipoAreaApoPri, Integer.parseInt(idFilialPri), idEjeX);
              ...
              case 17: {
               ...
               case 33:{
                   ...
                   //Fin de la funcion                     
                    ...
                    request.getSession().setAttribute("Listar_Ejes_Objetivos_Estrategicos_Temporada",ges.Listar_Ejes_Objetivos_Estrategicos_Temporada(id, idTipoAreaApoPri ));
                    request.getSession().setAttribute("Listar_Rango_Temporada", ges.Listar_Rango_Temporada(id));
                    //Esta funcion carga Valores
                    principalValorSession(request);
                    //Fin de la funcion
        ...
        //Esta funcion carga Valores
               ...
               case 43:{
                   ...
                   //Fin de la funcion                      
                    ...
                    request.getSession().setAttribute("Listar_Estrategias_eje",ges.Listar_Estrategias_eje(id,idTipoAreaApoPri, Integer.parseInt(idFilialPri)));
               ...
               case 51:{
                   ...
                   //Fin de la funcion                    
                    ...
                    request.getSession().setAttribute("Listar_Estrategias_Indicador",ges.Listar_Estrategia_Indicador(id, idTipoAreaApoPri, Integer.parseInt(idFilialPri)));
                    ges=new GestionEstrategicoService();
                    List listarIndicadores = ges.Listar_Indicador(idTipoAreaApoPri, Integer.parseInt(idFilialPri), idEjeEstrategicoPri);
                    request.getSession().setAttribute("listar_indicador", listarIndicadores);
               ...
               case 54: {
                ...
                case 56:{
                   ...
                   ges=new GestionEstrategicoService();
                   List listEstrategia = ges.Listar_Estrategia(idTipoAreaApoPri, Integer.parseInt(idFilialPri));
               ...
               case 77: {
                   ...
                   // LISTAR FILIAL FACULTAD SEGUN LA FILIAL SELECCIONADA PERIODO FILIAL ::::::::::::::::::::::::::::
                    ...
                    request.getSession().setAttribute("listar_Filial_Facultad_Combo",os.listar_filial_facultad_desde_usuario(idFilial, idTipoAreaApoPri) );
