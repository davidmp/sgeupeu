 ...
 * @author Intel
 */
@WebServlet(name = "InformesActividadApoyo", urlPatterns = {"/InformesActividadApoyo"})
public class InformesActividadApoyo extends HttpServlet {

   private static String INDEXCOORDINADOREAPINFORME= "apps/app_informesactividad/indexApoyo.jsp";
   private static String INDEXCOORDINADOREAPMAIN= "apps/app_informesactividad/main_actividadApoyo.jsp";
   private static String INDEXCOORDINADOREAPREPOR1= "apps/app_informesactividad/reporteGeneralAreaApoyo.jsp";
