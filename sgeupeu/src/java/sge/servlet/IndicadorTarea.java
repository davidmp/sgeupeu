 ...
 * @author Intel
 */
@WebServlet(name = "IndicadorTarea", urlPatterns = {"/IndicadorTarea"})
public class IndicadorTarea extends HttpServlet {

   private static String INDEXCOORDINADOREAPINFORME= "apps/app_tareas/index.jsp";
   private static String INDEXCOORDINADOREAPMAIN= "apps/app_tareas/main_tarea.jsp";
