 ...
 * @author Intel
 */
@WebServlet(name = "UsuarioApoyo", urlPatterns = {"/UsuarioApoyo"})
public class UsuarioApoyo extends HttpServlet {
    ...
    private static String INDEXFILIALFACULTADEAP= "apps/app_organizacion_apoyo/index_facultad_eap_filial.jsp";
    private static String LISTAFILIALFACULTADFILIAL= "apps/app_organizacion_apoyo/list_filial_facultad.jsp";
    private static String ADDFILIALFACULTADPERIODOFILIAL= "apps/app_organizacion_apoyo/add_filial_facultad_periodo.jsp";
    private static String ADDFILIALFACULTADFILIAL= "apps/app_organizacion_apoyo/add_filial_facultad_filial.jsp";
    private static String ADDCOORDINADOREJEFILIAL= "apps/app_organizacion_apoyo/add_eap_ejecoordinador.jsp";
    
    // LIST EAP-FACULTAD - DESDE USUARIO FILIAL    
    private static String LISTAEAPFACULTADFILIAL= "apps/app_organizacion_apoyo/list_eap_facultad.jsp";
    private static String ADDEAPFACULTADFILIAL= "apps/app_organizacion_apoyo/add_eap_facultad_filial.jsp";
             ...
             case 2: {
                ...
                case 4: {
                    ...
                    request.getSession().setAttribute("facultadUsuario",uss.facultadUsuario(uss.Id_usuario(request)));
                        ...
                        if(Integer.parseInt(w.getIdcategoriausuario())==4){
                    request.getSession().setAttribute("eapUsuario",uss.eapUsuario(uss.Id_usuario(request)));
                    request.getSession().setAttribute("facultadUsuario",uss.facultadUsuario(uss.Id_usuario(request)));
                        }else{
               ...
               case 51: {
                   ...
                   String namepre = "Administracion de Coordinadores";
                   String datapre = " Personas - coordinadores ";
               ...
               case 54: {
                ...
                case 59: {
                   ...
                   String namepre = "Selecciona un Periodo para ver los Coordinadores";
                   String datapre = " Personas - coordinadores E.A.P ";
               ...
               case 66: {
                   ...
                   String namepre = "Gestion de Unidades de Apoyo y/o Areas de Apoyo";
                   String datapre = " Personas - Director Unidad de Apoyo- Directores de Direcciones de Apoyo";
               ...
               case 67: {
                   ...
                   request.getSession().setAttribute("listaFilialFacultadfilial", os.listar_filial_facultad_desde_usuario(idfi, idTipoAreaApoPri));
                ...
                case 73: {
                 ...
                 case 74: {
                   ...
                   case 76: {
                    ...
                    request.getSession().setAttribute("listaPersonasFilial", us.listar_personas_filial(idfi));
                    os=new OrganizacionService();
                    List facultad = os.Listar_FacultadesAreas(idTipoAreaApoPri);
                    ...
                    request.getSession().setAttribute("listaEAPFacultadfilial", os.Listar_Eap_FacultadPrimero(idfi,idTipoAreaApoPri));
                    ...
                    os=new OrganizacionService();
                    List eap = os.Listar_Eap(idTipoAreaApoPri);
